...
class NumToWord {
    ...
    public class NumberToWords {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Welcome to number to Word Conversion");
            number.convert_to_words("9923".toCharArray());
            number.convert_to_words("529".toCharArray());
            number.convert_to_words("729".toCharArray());
